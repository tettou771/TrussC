...
/*
    ...
    Cmdline:
        sokol-shdc -i C:/TrussC/TrussC/trussc/shaders/lut.glsl -o C:/TrussC/TrussC/trussc/include/tc/gpu/shaders/lut.glsl.h -l metal_macos:hlsl5:glsl300es:wgsl --ifdef
