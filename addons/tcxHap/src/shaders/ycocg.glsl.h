...
/*
    ...
    Cmdline:
        sokol-shdc --input C:/TrussC/TrussC/addons/tcxHap/src/shaders/ycocg.glsl --output C:/TrussC/TrussC/addons/tcxHap/src/shaders/ycocg.glsl.h --slang metal_macos:hlsl5:glsl300es:wgsl --format sokol
